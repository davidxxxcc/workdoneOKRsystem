...
--
-- Host: localhost:3306
-- Generation Time: Jan 03, 2018 at 05:57 AM
...
(2, 'C001', '理財寶-金融科技部', 1, '', '理財寶-金融科技部', 0),
(3, 'C001', '人力資源部', 2, '', '', 0);
...
('54e72894-f04a-11e7-80e0-74d02b1dfe7c', 'C001', 3, '人力資源部/人資副理', 'athena_tsai@cmoney.com.tw', '123456', '蔡毓蓉', 'https://vignette.wikia.nocookie.net/peanuts/images/d/dc/Woodstock.gif/revision/latest?cb=20090301022138', 'C001^p^2018Q1', '', '', 0, 0, 0),
...
('7504e020-f04a-11e7-80e0-74d02b1dfe7c', 'C001', 3, '人力資源部/人資專員', 'grace_chian@cmoney.com.tw', '123456', '錢翊綺', 'https://vignette.wikia.nocookie.net/peanuts/images/d/dc/Woodstock.gif/revision/latest?cb=20090301022138', 'C001^p^2018Q1', '', '', 0, 0, 0),
...
ALTER TABLE `notification`
  ...
  ADD KEY `Emp_UUID` (`Emp_UUID`),
  ADD KEY `Obj_ID` (`Obj_ID`),
  ADD KEY `sourse_UUID` (`Sourse_UUID`);
...
--
ALTER TABLE `department`
  MODIFY `Dpm_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '部門ID', AUTO_INCREMENT=4;
--
...
ALTER TABLE `notification`
  ...
  ADD CONSTRAINT `notification_ibfk_3` FOREIGN KEY (`Sourse_UUID`) REFERENCES `employee` (`Emp_UUID`);
